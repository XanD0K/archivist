...
void handle_help(void)
{
    puts(
        ...
        "               Usage: ./archivist tree '[SRC_DIR]' [FLAGS]\n"
        "\n"
...
void print_backup_help(void)
{
    puts(
        "Usage: ./archivist backup '[SRC_DIR]' 'DST_DIR' [FLAGS]\n"
        "\n"
        "SRC_DIR is the origin directory. It defaults to current directory (.)\n"
        "DST_DIR is the destination directory. It is a required argument\n"
        "If DST_DIR path directory doesn't exist, it will be created\n"
        "\n"
        "Flags:\n"
        "   -a | --all\n"
        ...
        "   ./archivist backup '/folder1' '/folder2' -c word\n"
...
void print_list_help(void)
{
    puts(
        ...
        "./archivist list '/folder' -s size -R --all\n"
...
void print_rename_help(void)
{
    puts(
        ...
        "   ./archivist rename '/folder' -A --min-size 50K --max-size 50G\n"        
        "\n"
        "All commands: ./archivist help"
    );
}
...
void print_report_help(void)
{
    puts(
        ...
        "       sorts output by:\n"
        "           name → compares the ASCII value of each character\n"
        "           size → compares the total size of each extension\n"
        "           quantity → compares total number of files of each extension\n"
        "       default: name\n"
        "   -R | --recursive\n"
        "       also lists subdirectories\n"
        "       default: off\n"
        ...
        "   ./archivist report '/folder' --human-readable --all\n"
        "   ./archivist report '/folder' --almost-all -R\n"
        "\n"
        "All commands: ./archivist help"
    );
}
...
void print_tree_help(void)
{
    puts(
        ...
        "\n"
        "SRC_DIR defaults to current directory (.) if not provided\n"
        "\n"
        "Flags:\n"
        "   -a | --all\n"
        "       includes hidden files and hidden directories\n"
