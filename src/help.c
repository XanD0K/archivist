...
void handle_help(void)
{
    puts(
        ...
        "               Usage: ./archivis recover [DIRECTORY] DIRECTORY [FLAGS]\n"
        "\n"
...
void print_rename_help(void)
{
    puts(
        ...
        "   ./archivist rename /folder --name new_name -c word\n"
...
void print_backup_help(void)
{
    puts(
        ...
        "Flags:\n"
        "   -c | --contains\n"
        "       backups only files that contain a word/pattern\n"
        "   -d | --dry-run\n"
        "       simulates changes, showing the result\n"
        "       default: off\n"
        "   -e | --extension\n"
        "       only backups files of given extension\n"
        "       if more than 1 extension, separate them with a comma\n"
        "       e.g. txt | .txt\n"
        "   -h | --human-readable\n"
