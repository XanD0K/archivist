...
void print_backup_help(void)
{
    puts(
        ...
        "       default: off\n"
        "   -R | --recursive\n"
        "       also makes backup of all files in subdirectories\n"
        "       default: off\n"
        "   --min-size\n"
        "   --max-size\n"
        ...
        "   ./archivist backup /folder1 /folder2 -i -v -R\n"
        "   ./archivist backup /folder1 /folder2 --min-size 50K --max-size 50G\n"        
        "\n"
...
void print_delete_help(void)
{
    puts(
        ...
        "       default: off\n"
        "   -R | --recursive\n"
        "       also deletes all files in subdirectories\n"
        "       default: off\n"
        "   --min-size\n"
        "   --max-size\n"
        "       only consider files smaller/larger than specified value\n"
...
void print_list_help(void)
{
    puts(
        ...
        "./archivist list /folder -h -i --sort version\n"
        "\n"
        "All commands: ./archivist help"
    );
}
...
void print_move_help(void)
{
    puts(
        ...
        "       default: off\n"
        "   -R | --recursive\n"
        "       also moves all files in subdirectories\n"
        "       default: off\n"
        "   --min-size\n"
        "   --max-size\n"
        "       only consider files smaller/larger than specified value\n"
...
void print_rename_help(void)
{
    puts(
        ...
        "       default: off\n"
        "   -R | --recursive\n"
        "       also renames all files in subdirectories\n"
        "       default: off\n"
        "   --min-size\n"
        "   --max-size\n"
        "       only consider files smaller/larger than specified value\n"
        ...
        "   ./archivist rename /folder -i -v -R\n"
        "   ./archivist rename /folder -h --min-size 50K --max-size 50G\n"        
        "\n"
        "All commands: ./archivist help"
    );
}
...
void print_recover_help(void)
{
    puts(
        ...
        "   ./archivist recover /folder1 /folder2 -i\n"
        "\n"
        "All commands: ./archivist help"       
    );
}
...
void print_search_help(void)
{
    puts(
        ...
        "Flags:\n"
        "   -c | --contains\n"
        "       includes all files/directories that contain a word/pattern\n"
        "   -e | --extension\n"
        "       displays information only of specified extensions\n"
        "       if more than 1 extension, separate them with a comma\n"
        "   -t | --type\n"
        ...
        "./archivist search /folder -t file\n"
        "./archivist search /folder -R --min-size 50K --max-size 50G\n"
        "\n"
